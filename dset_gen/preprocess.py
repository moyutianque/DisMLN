...
num_process =100
# Load maps
annt_root = '/data/leuven/335/vsc33595/ProjectsVSC/DisMLN/dset_gen/generated/cache_full_merge'
...
def process_one_ep(datum, ep_idx):
    ...
    with jsonlines.open(f'./dset_gen/generated/cache_full_merge/tmp_preprocessed/{ep_idx}.jsonl', 'w') as writer:
        writer.write({
