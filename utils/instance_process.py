...
# @execution_time
def get_surrounding_objs(obj_map, nav_map, agent_grid_pos, radius, floor_idx=1, exemption_list=[1,16,38,39], meter_per_pixel=0.05, is_radian=False, skip_not_valid=False):
    """
    Args:
...
# @execution_time
def get_room_compass(room_map, nav_map, agent_grid_pos, radius=None, num_chunks=12, exemption_list=[], meter_per_pixel=0.05, is_radian=False):
    """
    room_status: {
